...
Public Class frmCustomerRotation

    Private Sub frmCustomerRotation_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp, CRV.KeyUp, txtDateFrom.KeyUp, txtDateTo.KeyUp
        If e.KeyCode = Keys.End Then
            Me.Close()
        End If
    End Sub
    Private Sub frmCustomerRotation_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub LoadReport()
        Try
            ...
            DT = DBO.ExecuteSP_ReturnDataTable("Sale_CustomerRotation", PARA)

            Dim report As New ReportDocument
            report.Load(CLS_Config.ReportPath & "Customer Rotation.rpt", CrystalDecisions.[Shared].OpenReportMethod.OpenReportByTempCopy)
