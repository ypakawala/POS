...
Public Class frmCustomerBalanceInDuration

    Private Sub frmCustomerBalance_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp, CRV.KeyUp, txtDateTo.KeyUp, txtDateFrom.KeyUp
    ...
    Private Sub btnClearAll_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnClearAll.Click
        Try
            ...
            Me.txtDateFrom.Value = Now.Date 'New DateTime(Now.Year, Now.Month, 1, 0, 0, 0)
    ...
    Private Sub LoadReport()
        Try
            ...
            'DT = DBO.ExecuteSP_ReturnDataTable("Sale_CustomerBalance", PARA)

            Dim report As New ReportDocument
            report.Load(CLS_Config.ReportPath & "Customer Balance In Duration.rpt", CrystalDecisions.[Shared].OpenReportMethod.OpenReportByTempCopy)
            ...
            report.SetParameterValue("@FromDate", FixControl(Me.txtDateFrom))
            report.SetParameterValue("@ToDate", FixControl(Me.txtDateTo))
