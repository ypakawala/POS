...
Public Class frmItemMovementSummary
    ...
    Private Sub LoadReport()
        Try
            ...
            DT = DBO.ExecuteSP_ReturnDataTable("ItemMovementSummary", PARA)

            Dim report As New ReportDocument
            report.Load(CLS_Config.ReportPath & "Item Movement Summary.rpt", CrystalDecisions.[Shared].OpenReportMethod.OpenReportByTempCopy)
