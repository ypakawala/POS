...
Public Class frmCustomerPaid

    Private Sub frmCustomerPaid_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp, CRV.KeyUp, txtDateFrom.KeyUp, txtDateTo.KeyUp
        If e.KeyCode = Keys.End Then
            Me.Close()
        End If
    End Sub
    Private Sub frmCustomerPaid_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub LoadReport()
        Try
            ...
            DT = DBO.ExecuteSP_ReturnDataTable("Sale_CustomerPaid", PARA)

            Dim report As New ReportDocument
            report.Load(CLS_Config.ReportPath & "Customer Paid.rpt", CrystalDecisions.[Shared].OpenReportMethod.OpenReportByTempCopy)
