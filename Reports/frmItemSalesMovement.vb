...
Public Class frmItemSalesMovement
    Private Sub frmSailSearch_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp, CRV.KeyUp, DropCustomer.KeyUp, DropItem.KeyUp, DropUser.KeyUp, MenuStrip1.KeyUp, txtDateFrom.KeyUp, txtDateTo.KeyUp, UltraExpandableGroupBox1.KeyUp
    ...
    Private Function Where() As String
        ...
        Try
            ...
            If FixControl(Me.DropCustomer) <> Nothing Then Result &= " AND AccountNum = " & FixControl(Me.DropCustomer)
    ...
    Private Sub LoadReport()
        Try
            ...
            report.Load(CLS_Config.ReportPath & "Item Sales Movement.rpt", CrystalDecisions.[Shared].OpenReportMethod.OpenReportByTempCopy)
            ...
            report.SetParameterValue("ItemCode", Me.DropItem.Value)
            report.SetParameterValue("DateFrom", Me.txtDateFrom.Value)
            report.SetParameterValue("DateTo", Me.txtDateTo.Value)
