...
Public Class Purchase
    ...
    Private m_DebitNote As Decimal = 0.0
    Private m_Discount As Decimal = 0.0
    Private m_TotalAmount As Decimal = 0.0
    ...
    Public Property Amount() As Decimal
        ...
        End Set
    End Property
    Public Property DebitNote() As Decimal
        Get
            Return m_DebitNote
        End Get
        Set(ByVal value As Decimal)
    ...
    Public Function Add() As Integer
        Try
            ...
            PARA.Add(FixObjectNumber(m_DebitNote))
            PARA.Add(FixObjectNumber(m_Discount))
            PARA.Add(FixObjectNumber(m_TotalAmount))
            ...
            m_Code = DBO.ExecuteSP_ReturnSingleValue("PurchaseInsert", PARA)
            Return m_Code
    ...
    Public Function Update() As Boolean
        Try
            ...
            DBO.ExecuteSP("PurchaseUpdate", PARA)
            Return True
    ...
    Public Function [Select](ByVal Code As Integer) As Boolean
        Try
            ...
            Dim PARA As New ArrayList
            PARA.Add(Code)
            DT = DBO.ExecuteSP_ReturnDataTable("PurchaseSelect", PARA)
            ...
            Else
                ...
                m_DebitNote = Decimal.Round(CDec(FixObjectNumber(DT.Rows(0).Item("DebitNote"))), 3)
                m_Discount = Decimal.Round(CDec(FixObjectNumber(DT.Rows(0).Item("Discount"))), 3)
                m_TotalAmount = Decimal.Round(CDec(FixObjectNumber(DT.Rows(0).Item("TotalAmount"))), 3)
    ...
    Public Function Delete() As Boolean
        Try
            ...
            DBO.ExecuteSP("PurchaseDelete", PARA)
            Return True
        ...
        End Try
    End Function
    Public Function [Balance](ByVal SupplierCode As Integer) As Double
        Try
            Dim DT As New DataTable
            Dim PARA As New ArrayList
