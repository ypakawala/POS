...
#Region "Methods"
    ...
    Private Sub FillGrid()
        Try
            ...
            DT.Clear()
            If btnDiscontinued.Checked = True Then
                DT = DBO.ReturnDataTableFromSQL("SELECT * FROM Item WHERE COALESCE(Discontinued,0)=1 ORDER BY Code DESC")
            Else
                DT = DBO.ReturnDataTableFromSQL("SELECT * FROM Item WHERE COALESCE(Discontinued,0)=0 ORDER BY Code DESC")
            End If
    ...
    Private Sub SetGridLayout()
        Try
            ...
            Me.grdList.DisplayLayout.Bands(0).Columns("LastPurchaseCost").Header.VisiblePosition = 19
            Me.grdList.DisplayLayout.Bands(0).Columns("onPromo").Header.VisiblePosition = 20
            Me.grdList.DisplayLayout.Bands(0).Columns("PromoFrom").Header.VisiblePosition = 21
            Me.grdList.DisplayLayout.Bands(0).Columns("PromoTo").Header.VisiblePosition = 22
            Me.grdList.DisplayLayout.Bands(0).Columns("PromoPrice").Header.VisiblePosition = 23
            Me.grdList.DisplayLayout.Bands(0).Columns("PromoStockLimit").Header.VisiblePosition = 24
            Me.grdList.DisplayLayout.Bands(0).Columns("PromoStockSold").Header.VisiblePosition = 25
            ...
            Me.grdList.DisplayLayout.Bands(0).Columns("onPromo").Hidden = True
            Me.grdList.DisplayLayout.Bands(0).Columns("PromoFrom").Hidden = True
            Me.grdList.DisplayLayout.Bands(0).Columns("PromoTo").Hidden = True
            Me.grdList.DisplayLayout.Bands(0).Columns("PromoPrice").Hidden = True
            Me.grdList.DisplayLayout.Bands(0).Columns("PromoStockLimit").Hidden = True
            Me.grdList.DisplayLayout.Bands(0).Columns("PromoStockSold").Hidden = True
            ...
            'Me.grdList.DisplayLayout.Bands(0).Columns("ItemType").Width = 100
            'Me.grdList.DisplayLayout.Bands(0).Columns("Notes").Width = 100
            'Me.grdList.DisplayLayout.Bands(0).Columns("CostMethod").Width = 100
            ...
            Select Case CLS_Config.Company
                ...
                Case CENTURY
                    ...
                    Me.grdList.DisplayLayout.Bands(0).Columns("StockInStore").Hidden = True
                    Me.grdList.DisplayLayout.Bands(0).Columns("StockTotal").Hidden = True
                    Me.grdList.DisplayLayout.Bands(0).Columns("StockMin").Hidden = True
                    ...
                    Me.grdList.DisplayLayout.Bands(0).Columns("LastPurchaseCost").Hidden = True
                    Me.grdList.DisplayLayout.Bands(0).Columns("Barcode2").Hidden = True
                    Me.grdList.DisplayLayout.Bands(0).Columns("StockMin").Hidden = True
                    Me.grdList.DisplayLayout.Bands(0).Columns("ProfitMargin").Hidden = True
                Case Else
            ...
            Me.grdList.DisplayLayout.Bands(0).Columns("Discontinued").Hidden = True
            ...
            Me.grdList.DisplayLayout.Bands(0).Columns("LastPurchaseCost").PerformAutoResize()
            Me.grdList.DisplayLayout.Bands(0).Columns("Discontinued").PerformAutoResize()
            Me.grdList.DisplayLayout.Bands(0).Columns("onPromo").PerformAutoResize()
            Me.grdList.DisplayLayout.Bands(0).Columns("PromoFrom").PerformAutoResize()
            Me.grdList.DisplayLayout.Bands(0).Columns("PromoTo").PerformAutoResize()
            Me.grdList.DisplayLayout.Bands(0).Columns("PromoPrice").PerformAutoResize()
            Me.grdList.DisplayLayout.Bands(0).Columns("PromoStockLimit").PerformAutoResize()
            Me.grdList.DisplayLayout.Bands(0).Columns("PromoStockSold").PerformAutoResize()

            Me.grdList.DisplayLayout.Bands(0).Columns("StockInStore").ExcludeFromColumnChooser = ExcludeFromColumnChooser.True
            Me.grdList.DisplayLayout.Bands(0).Columns("StockTotal").ExcludeFromColumnChooser = ExcludeFromColumnChooser.True
            ...
            Load_Save_XML(XML_Section.ItemList, Me.grdList, True)


            Me.grdList.DisplayLayout.Bands(0).Columns("StockInHand").Header.Caption = "Stock"
            ...
            Me.grdList.DisplayLayout.Bands(0).Columns("LastPurchaseCost").MaskInput = Mask_Amount
            ...
            Me.grdList.DisplayLayout.Bands(0).Columns("PromoStockLimit").MaskInput = Mask_Qty
            Me.grdList.DisplayLayout.Bands(0).Columns("PromoStockSold").MaskInput = Mask_Qty
            ...
            Me.grdList.DisplayLayout.Bands(0).Columns("LastPurchaseCost").CellActivation = Infragistics.Win.UltraWinGrid.Activation.NoEdit
            ...
            Me.grdList.DisplayLayout.Bands(0).Columns("StockInStore").TabStop = False
            ...
            Me.grdList.DisplayLayout.Bands(0).Columns("LastPurchaseCost").TabStop = False
            Me.grdList.DisplayLayout.Bands(0).Columns("Discontinued").TabStop = False
            Me.grdList.DisplayLayout.Bands(0).Columns("onPromo").TabStop = False
            Me.grdList.DisplayLayout.Bands(0).Columns("PromoFrom").TabStop = False
            Me.grdList.DisplayLayout.Bands(0).Columns("PromoTo").TabStop = False
            Me.grdList.DisplayLayout.Bands(0).Columns("PromoPrice").TabStop = False
            Me.grdList.DisplayLayout.Bands(0).Columns("PromoStockLimit").TabStop = False
            Me.grdList.DisplayLayout.Bands(0).Columns("PromoStockSold").TabStop = False

            If CLS_Config.ShowImage Then
                If Me.grdList.Rows.GetFilteredInNonGroupByRows.Count > 0 Then
                    Me.grdList.Rows.GetFilteredInNonGroupByRows(0).Activate()
                Else
                    Me.lblName.Text = Nothing
                    Me.lblCategory.Text = Nothing
                    Me.lblCostPrice.Text = Nothing
                    Me.lblSP.Text = Nothing
    ...
    Private Sub Save()
        Try
            ...
            If IsValid() Then
                ...
                CLS.onPromo = FixCellBoolean(Me.grdList.ActiveRow.Cells("onPromo"))
                CLS.PromoFrom = FixCellDate(Me.grdList.ActiveRow.Cells("PromoFrom"))
                CLS.PromoTo = FixCellDate(Me.grdList.ActiveRow.Cells("PromoTo"))
                CLS.PromoPrice = FixCellNumber(Me.grdList.ActiveRow.Cells("PromoPrice"))
                CLS.PromoStockLimit = FixCellNumber(Me.grdList.ActiveRow.Cells("PromoStockLimit"))
                CLS.PromoStockSold = FixCellNumber(Me.grdList.ActiveRow.Cells("PromoStockSold"))
                ...
                PARA.Add(CLS.onPromo)
                PARA.Add(CLS.PromoFrom)
                PARA.Add(CLS.PromoTo)
                PARA.Add(CLS.PromoPrice)
                PARA.Add(CLS.PromoStockLimit)
                PARA.Add(CLS.PromoStockSold)
    ...
    Private Sub Delete()
        Try
            ...
            Else
                ...
                Dim Barcode As String = Me.grdList.ActiveRow.Cells("Barcode").Value
                Dim Code As Integer = Me.grdList.ActiveRow.Cells("Code").Value


                Dim i As MsgBoxResult
                i = MSG.WarnYesNo("Are you sure you want to delete selected record?" & vbCrLf & vbCrLf & "Code: " & Code & vbCrLf & "Item Name: " & ItemName & vbCrLf & "Barcode: " & Barcode, 2)
                If i = MsgBoxResult.Yes Then
                    ...
                    If Result = 0 Then
                        If MsgBox("Cant Delete, item already in use." & vbCrLf & vbCrLf & "Code: " & Code & vbCrLf & "Item Name: " & ItemName & vbCrLf & "Barcode: " & Barcode & vbCrLf & vbCrLf & "Discontinued Item?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                            isEditing = True

                            Me.grdList.ActiveRow.Cells("Discontinued").Value = True
...
#Region "Events"
    ...
    Private Sub grdList_AfterRowActivate(sender As Object, e As EventArgs) Handles grdList.AfterRowActivate
        Try
            ...
            Me.lblName.Text = TrimStr(Me.grdList.ActiveRow.Cells("ItemName").Value)
            Me.lblCategory.Text = getValueFromDrop(CType(Me.DropCategory.DataSource, DataTable), "Code", TrimInt(Me.grdList.ActiveRow.Cells("Category").Value), "Title")
            Me.lblCostPrice.Text = ConvertToString(TrimDec(Me.grdList.ActiveRow.Cells("CostPrice").Value), False)
            Me.lblSP.Text = ConvertToString(TrimDec(Me.grdList.ActiveRow.Cells("SalesPrice").Value), False)
            Me.lblStock.Text = ConvertToString(TrimDec(Me.grdList.ActiveRow.Cells("StockInHand").Value) + TrimDec(Me.grdList.ActiveRow.Cells("StockInStore").Value), False)
    ...
    Private Sub frmItemList_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Load_Save_XML(XML_Section.ItemList, Me.grdList, False)
    End Sub
    ...
    Private Sub btnDiscontinued_Click(sender As Object, e As EventArgs) Handles btnDiscontinued.Click
        If btnDiscontinued.CheckState = CheckState.Checked Then
            Me.btnDiscontinued.BackColor = Color.Transparent
            btnDiscontinued.Checked = False
            btnDiscontinued.Text = "Discontinued OFF"
        Else
            Me.btnDiscontinued.BackColor = Color.LightBlue
            btnDiscontinued.Checked = True
            btnDiscontinued.Text = "Discontinued ON"
        End If
    ...
    Private Sub SetChangePrice()
        Try
            ...
            Else
                ...
                If UserClass.CanAdjustStock Then
...
#End Region
    ...
    Private Sub grdList_MouseEnterElement(sender As Object, e As UIElementEventArgs) Handles grdList.MouseEnterElement
